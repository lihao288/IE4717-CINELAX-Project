...
<body>
  ...
  if (isset($_POST['product'])) {
    ...
    echo (number_format((float)$justjava_sales, 2));
    echo "</td><td>";
    echo ($justjava_totalqty);
    echo "</td></tr>";
    echo "<tr><td>Cafe au Lait</td><td>$";
    echo (number_format((float)$lait_sales, 2));
    echo "</td><td>";
    echo ($lait_totalqty);
    echo "</td></tr>";
    echo "<tr><td>Iced Cappuccino</td><td>$";
    echo (number_format((float)$cappuccino_sales, 2));
    echo "</td><td>";
    ...
    echo " Single ($";
    echo (number_format((float)$lait_single_sales, 2));
    echo "), ";
    echo ($lait_double_qty);
    echo " Double ($";
    echo (number_format((float)$lait_double_sales, 2));
    echo ")<br/>";
    echo "Iced Cappuccino - ";
    echo ($cappuccino_single_qty);
    echo " Single ($";
    echo (number_format((float)$cappuccino_single_sales, 2));
    echo "), ";
    echo ($cappuccino_double_qty);
    echo " Double ($";
    echo (number_format((float)$cappuccino_double_sales, 2));
    echo ")</p>";
  ...
  if (isset($_POST['category'])) {
    ...
    echo (number_format((float)$single_sales, 2));
    echo "</td><td>";
    echo ($single_totalqty);
    echo "</td></tr>";
    echo "<tr><td>Double</td><td>$";
    echo (number_format((float)$double_sales, 2));
    echo "</td><td>";
